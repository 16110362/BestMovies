package com.example.henri.bestmovie.adapter;
...
import com.example.henri.bestmovie.TheMovies;
import com.example.henri.bestmovie.R;
    ...
    public void onBindViewHolder(final MovieHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                final Intent detail = new Intent(holder.itemView.getContext(), TheMovies.class);
